...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE produtos SET nome = :nome, preco = :preco, quantidade = :quantidade, fabricacao = :fabricacao WHERE id = :id";
        ...
        <div class="card-body">
            <form method="POST" action="editar.php?id=<?= $id ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="fabricacao" value="<?= $produto['fabricacao'] ?>">
                </div>
